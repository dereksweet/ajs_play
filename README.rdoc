...
These installation instructions are aimed at _OSX_ users. They also presume a general familiarty with Rails 4 and testing methodologies. If you need to get started with Rails on OSX here is a guide: https://gorails.com/setup/osx/10.11-el-capitan. NPM is also used to setup some packages so ensure you have it and Node installed and running: http://coolestguidesontheplanet.com/installing-node-js-on-osx-10-10-yosemite/.
...
It may be required to update your Java Development Kit as well to JDK7
...
"*Beginning* *AngularJS*" by Andrew Grant - http://www.amazon.ca/Beginning-AngularJS-Andrew-Grant-ebook/dp/B00M4FC72S/ref=tmm_kin_swatch_0?_encoding=UTF8&sr=8-1&qid=1425747905

"*Pro* *AngularJS*" by Adam Freeman - http://www.amazon.com/Pro-AngularJS-Experts-Voice-Development/dp/1430264489/ref=sr_1_1?ie=UTF8&qid=1425829692&sr=8-1&keywords=angularjs

"*Angular* *Style* *Guide*" by John Papa - https://github.com/johnpapa/angular-styleguide

=== Tools

"*dirPagination*" by Michael Bromley - Part of the angularUtils package - https://github.com/michaelbromley/angularUtils/tree/master/src/directives/pagination

"*Countries*" by Hexorx - Used to obtain countries data - https://github.com/hexorx/countries
